...
namespace GrpcServiceDemo {
  public static partial class CustomerProcess
  {
    ...
    /// <summary>Base class for server-side implementations of CustomerProcess</summary>
    [grpc::BindServiceMethod(typeof(CustomerProcess), "BindService")]
    public abstract partial class CustomerProcessBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::GrpcServiceDemo.ShowResponse> AddCustomer(global::GrpcServiceDemo.AddRequest request, grpc::ServerCallContext context)
      {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(CustomerProcessBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, CustomerProcessBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_AddCustomer, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GrpcServiceDemo.AddRequest, global::GrpcServiceDemo.ShowResponse>(serviceImpl.AddCustomer));
    }
